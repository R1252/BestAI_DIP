...
//            // Check if the 'Scene Configuration' setting exists and retrieve its value
//            if let sceneConfig = infoDict["Scene Configuration"] as? [String], !sceneConfig.contains("RoomCaptureSession") {
//                configurationName = "Unsupported Device"
//            }
//        }
//        
